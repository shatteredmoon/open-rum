class U1_Invisible_Seeker_Creature extends U1_NPC
{
  function OnDeath( i_ciSource, i_bKillCredit = true )
  {
    ...
    {
      // Credit for quest?
      local eQuestState = i_ciSource.GetProperty( U1_Quest_Rondorin_PropertyID, U1_KingQuestState.Unbestowed1 );
      if( U1_KingQuestState.Bestowed2 == eQuestState )
      {
        i_ciSource.SetProperty( U1_Quest_Rondorin_PropertyID, U1_KingQuestState.Completed2 );
