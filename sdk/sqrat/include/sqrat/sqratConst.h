...
public:
    ...
    virtual Enumeration& Const( const SQChar* name, const int64_t val ) {
        BindValue<SQInteger>( name, val, false );
        return *this;
    }

    virtual Enumeration& Const(const SQChar* name, const int32_t val) {
        BindValue<SQInteger>(name, val, false);
        return *this;
    }

    virtual Enumeration& Const( const SQChar* name, const uint32_t val ) {
      BindValue<SQInteger>( name, val, false );
      return *this;
    }
...
public:
    ...
    virtual ConstTable& Const(const SQChar* name, const int32_t val) {
        Enumeration::Const(name, val);
        return *this;
    }

    virtual ConstTable& Const( const SQChar* name, const uint32_t val ) {
      Enumeration::Const( name, val );
      return *this;
    }
