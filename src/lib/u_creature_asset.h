#ifndef _U_CREATURE_ASSET_H_
#define _U_CREATURE_ASSET_H_

#include <u_pawn_asset.h>


class rumCreatureAsset : public rumPawnAsset
{
public:
  ...
  static rumCreatureAsset* Fetch( rumAssetID i_eAssetID );

  static const std::string GetAssetClassName();

  typedef std::unordered_map< rumAssetID, rumCreatureAsset* > AssetHash;
