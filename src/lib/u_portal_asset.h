#ifndef _U_PORTAL_ASSET_H_
#define _U_PORTAL_ASSET_H_

#include <u_pawn_asset.h>


class rumPortalAsset : public rumPawnAsset
{
public:
  ...
  static rumPortalAsset* Fetch( rumAssetID i_eAssetID );

  static const std::string GetAssetClassName();

  typedef std::unordered_map< rumAssetID, rumPortalAsset* > AssetHash;
