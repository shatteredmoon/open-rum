#ifndef _U_BROADCAST_ASSET_H_
#define _U_BROADCAST_ASSET_H_
...
class rumBroadcastAsset : public rumAsset
{
public:
  ...
  static rumBroadcastAsset* Fetch( rumAssetID i_eAssetID );

  static const std::string GetAssetClassName();

  typedef std::unordered_map< rumAssetID, rumBroadcastAsset* > AssetHash;
